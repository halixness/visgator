...
class TextEncoder(nn.Module):
    ...
    def _unflatten(self, batch: Batch, tokens: Tensor) -> list[CaptionEmbeddings]:
        ...
        for sample in batch:
            ...
            captions.append(CaptionEmbeddings(entities=entities, relations=relations))
...
def build_encoders(config: EncodersConfig, return_model=False) -> tuple[VisionEncoder, TextEncoder]:
